    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        >
          ...
          >
            <View><Text>Trending Tab</Text></View>
          </TabBarIOS.Item>
          <TabBarIOS.Item
            title="Funny"
            icon={{ uri: funny, scale: 1.5 }}
            selected={this.state.selectedTab === 'Funny'}
            onPress={() => this.setState({ selectedTab: 'Funny' })}
          >
            <View><Text>Funny Tab</Text></View>
          </TabBarIOS.Item>
          <TabBarIOS.Item
            title="Feel Good"
            icon={{ uri: heart, scale: 1.5 }}
            selected={this.state.selectedTab === 'Feel Good'}
            onPress={() => this.setState({ selectedTab: 'Feel Good' })}
          >
            <View>
              <Text>FeelGood Tab</Text>
            </View>
          </TabBarIOS.Item>
          <TabBarIOS.Item
            title="Random"
            icon={{ uri: random, scale: 1.5 }}
            selected={this.state.selectedTab === 'Random'}
            onPress={() => this.setState({ selectedTab: 'Random' })}
          >
            <View><Text>Random Tab</Text></View>
          </TabBarIOS.Item>
        </TabBarIOS>
      </View>
    );
